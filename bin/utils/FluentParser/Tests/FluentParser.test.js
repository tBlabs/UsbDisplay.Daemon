...
testCases.forEach(test => {
    it(test.label, (done) => {
        const parser = test.parserDef(new FluentParserBuilder_1.FluentParserBuilder()).Build();
...
describe('FluentParser', () => {
    let parserBuilder;
    beforeEach(() => {
        parserBuilder = new FluentParserBuilder_1.FluentParserBuilder();
    });
    ...
    it('real life test', () => {
        ...
        const parser = (new FluentParserBuilder_1.FluentParserBuilder())
            .Is(0xBB).Is(0xAA)
            .If(0x01, 'type', _ => _)
...
//# sourceMappingURL=FluentParser.test.js.map